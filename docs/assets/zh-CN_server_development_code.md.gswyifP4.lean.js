import{_ as n,E as e,c as t,J as a,V as s,o as h}from"./chunks/framework.fogKwqBf.js";const B=JSON.parse('{"title":"源码","description":"","frontmatter":{},"headers":[],"relativePath":"zh-CN/server/development/code.md","filePath":"zh-CN/server/development/code.md"}'),l={name:"zh-CN/server/development/code.md"},p=s("",17),k=s("",18),r=s("",21),E=s("",21),d=s("",13);function o(c,g,y,u,F,C){const i=e("mermaid");return h(),t("div",null,[p,a(i,{dsl:`flowchart LR
    access-->domain
    domain-->storage
    access-->infra
    domain-->infra
