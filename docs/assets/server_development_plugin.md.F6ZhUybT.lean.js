import{_ as e,D as t,c as a,I as n,a3 as s,o as l}from"./chunks/framework.ViWktWD6.js";const m=JSON.parse('{"title":"Custom Plugins","description":"","frontmatter":{},"headers":[],"relativePath":"server/development/plugin.md","filePath":"server/development/plugin.md"}'),p={name:"server/development/plugin.md"},o=s("",8),h=s("",45);function r(d,c,k,u,g,E){const i=t("mermaid");return l(),a("div",null,[o,n(i,{dsl:`stateDiagram-v2
	[*] --> Loaded: Load
