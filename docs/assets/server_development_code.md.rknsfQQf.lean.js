import{_ as a,E as n,c as t,J as e,V as s,o as h}from"./chunks/framework.fogKwqBf.js";const b=JSON.parse('{"title":"Source Code","description":"","frontmatter":{},"headers":[],"relativePath":"server/development/code.md","filePath":"server/development/code.md"}'),l={name:"server/development/code.md"},r=s("",17),p=s("",18),k=s("",20),o=s("",21),d=s("",13);function c(E,g,y,u,m,F){const i=n("mermaid");return h(),t("div",null,[r,e(i,{dsl:`flowchart LR
    access-->domain
    domain-->storage
    access-->infra
    domain-->infra
