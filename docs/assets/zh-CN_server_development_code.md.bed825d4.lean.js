import{_ as o,c as l,E as a,R as s,o as e,G as p}from"./chunks/framework.b6850781.js";const g=JSON.parse('{"title":"源码","description":"","frontmatter":{},"headers":[],"relativePath":"zh-CN/server/development/code.md"}'),t={name:"zh-CN/server/development/code.md"},c=s("",17),r=s("",18),D=s("",21),y=s("",21),F=s("",13);function A(C,i,d,u,m,f){const n=p("mermaid");return e(),l("div",null,[c,a(n,{dsl:`flowchart LR
    access-->domain
    domain-->storage
    access-->infra
    domain-->infra
